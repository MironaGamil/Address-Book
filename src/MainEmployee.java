	...
	public static void on_button_click() {
		searchNameButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MySQLAccess.search_by_name(searchNameField.getText());
			}
		});
		...
		searchCompanyButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				MySQLAccess.search_by_company_name(searchCompanyField.getText());
			}
		});
		...
		deleteButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				boolean execute= MySQLAccess.delete_employee(Integer.parseInt(deleteField.getText()));
				if(execute){
		...
		editButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String employee = MySQLAccess.search_by_id(Integer.parseInt(editField.getText()));
				if(employee.equals("")){
					JOptionPane.showMessageDialog(guiFrame, "not found!");
				}
				else{
					String faxnumbers = MySQLAccess.search_fax_by_id(Integer.parseInt(editField.getText()));
