	...
	public static void on_button_click() {
		searchButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				control.MySQLAccess.search_agent_by_name(searchField.getText());
			}
		});
		...
		deleteButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				boolean execute= control.MySQLAccess.delete_agent(Integer.parseInt(deleteField.getText()));
				if(execute){
		...
		editButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String agent = control.MySQLAccess.search_agent_by_id(Integer.parseInt(editField.getText()));
				if(agent.equals("")){
